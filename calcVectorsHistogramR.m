function densities = calcVectorsHistogramR(vectorsMat,scale,binWidth)
...
% **** vectorsMat 无需归一化，给定范围scale和精度binWidth
...
% end
vectorsMat(vectorsMat<minValue) = minValue;
vectorsMat(vectorsMat>maxValue) = maxValue;

% 初始化直方图
binWidth = binWidth;
binSize = (maxValue-minValue)/binWidth + 1;
